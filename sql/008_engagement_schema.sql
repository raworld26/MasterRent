...
-- Purpose: interazione studente-proprietario: richieste di visita, ciclo di
--          prenotazione con caparra, storico stati, thread messaggi, preferiti
--          e recensioni.
...
--         -> (studente) deposit_paid  | cancellation_requested/completed/withdrawn.
...
-- Preferiti (solo studenti registrati).
