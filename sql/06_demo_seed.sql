...
-- File: sql/06_demo_seed.sql
-- Seed demo pulito: gli annunci sono solo quelli ricavati dalla cartella Case.
-- Ogni immobile ha una galleria isolata, senza riuso di foto tra annunci.
...
-- Unita affittabili: una sola unita per ogni sottocartella Case, cosi ogni
-- casa compare una sola volta nella ricerca.
...
-- Le caption sono descrittive e non espongono i nomi dei file originali.
